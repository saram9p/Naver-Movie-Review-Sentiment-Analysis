...
train_data[:2] # 상위 2개 출력

print('테스트용 리뷰 개수 :',len(test_data)) # 테스트용 리뷰 개수 출력

test_data[:2]

train_data['document'].nunique(), train_data['label'].nunique() # 중복 확인
...
print(train_data.isnull().values.any()) # null 값 있는지 확인

print(train_data.isnull().sum())

train_data.loc[train_data.document.isnull()] # null 값 위치 확인
...
train_data.loc[train_data.document.isnull()][:2]
